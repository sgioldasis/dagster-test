...
# Asset dependencies
# Note: Asset key includes package_name, schema (optimove), and model_name
FACT_VIRTUAL_ASSET_KEY = AssetKey(["dbt_optimove", "optimove", "stg_kaizen_wars__fact_virtual"])
