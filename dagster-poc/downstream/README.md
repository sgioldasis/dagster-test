...
```bash
cd /home/savas/dagster-test/dagster-poc/downstream
uv sync
```
...
|-------|-------------|--------------|
| `fact_virtual_count` | Counts records in `stg_kaizen_wars__fact_virtual` and writes to JSON | `dbt_optimove/optimove/stg_kaizen_wars__fact_virtual` |
