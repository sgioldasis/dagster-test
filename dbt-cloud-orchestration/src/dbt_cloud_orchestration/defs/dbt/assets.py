...
# Add these imports
from dagster import job, op, asset, FreshnessPolicy, LegacyFreshnessPolicy
from datetime import timedelta
import requests

# Define credentials
creds = DbtCloudCredentials(
    account_id=int(os.getenv("DBT_CLOUD_ACCOUNT_ID", "413")),
...
workspace = DbtCloudWorkspace(
    credentials=creds,
    project_id=int(os.getenv("DBT_CLOUD_PROJECT_ID", "10157")),
    environment_id=int(os.getenv("DBT_CLOUD_ENVIRONMENT_ID", "26829")),
)
